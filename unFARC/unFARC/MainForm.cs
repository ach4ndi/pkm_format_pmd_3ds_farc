        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (meta.configuration.path_over != "")
            {
                ...
                if (farcfile.isFarc)
                {
                    ...
                    textBox7.Text = farcfile.Header.Volume[0].Type + "";
                    textBox2.Text = "0x" + farcfile.Header.Volume[0].Sir0.Offset.toHexString();
                    textBox3.Text = farcfile.Header.Volume[0].Sir0.Lenght + "";
                    textBox5.Text = "0x" + farcfile.Header.Volume[0].DAT.Offset.toHexString();
                    textBox4.Text = farcfile.Header.Volume[0].DAT.Lenght + "";

                    if (farcfile.Header.Volume[0].Type == 5)
                    {
                        textBox6.Text = (int) ((SIR0f5) farcfile.FARCFAT).Header.FileCount + "";
                        textBox1.Text = (int) ((SIR0f5) farcfile.FARCFAT).Header.Type + "";
                        ...
                        {
                            lenghtfile = 2000;
                            tabPage5.Text = "Files [" + lenghtfile + "]h";
                        }
                    ...
                    {
                        textBox6.Text = (int) ((SIR0f4) farcfile.FARCFAT).Header.FileCount + "";
                        textBox1.Text = (int) ((SIR0f4) farcfile.FARCFAT).Header.Type + "";
                        ...
                        for (int i = 0; i < lenghtfile; i++)
                        {
                            dataGridView1.Rows.Add(i, ((SIR0f4)farcfile.FARCFAT).Header.FAT[i].FilenameString,
                                ...
                                "0x" + ((SIR0f4)farcfile.FARCFAT).Header.FAT[i].FileNameOffset.toHexString());
                        }
                    }
                }
                else
